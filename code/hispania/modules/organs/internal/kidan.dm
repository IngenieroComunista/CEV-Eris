/obj/item/organ/internal/liver/kidan
	name = "kidan liver"
	icon = 'icons/hispania/obj/species/organs/kidan.dmi'
...
/obj/item/organ/internal/eyes/kidan/get_icon()
	var/icon/eyes_icon = new/icon('icons/hispania/mob/human_face.dmi', "kidan_eye_l")
	eyes_icon.Blend(icon('icons/hispania/mob/human_face.dmi', "kidan_eye_r"), ICON_OVERLAY)
