...
/obj/item/weapon/robot_module/security/general/New(var/mob/living/silicon/robot/R)
	...
	src.modules += new /obj/item/weapon/gun/energy/egun_mounted_cyborg(src)
	...
	src.emag = new /obj/item/weapon/gun/energy/plasma/mounted(src)
	..(R)


/obj/item/weapon/robot_module/security/respawn_consumable(var/mob/living/silicon/robot/R, var/amount)
	..()
	var/obj/item/weapon/gun/energy/egun_mounted_cyborg/T = locate() in src.modules
